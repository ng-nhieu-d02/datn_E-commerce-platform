...
<style>
    ...
    <h1>Cập nhật thông tin Shop</h1>

    <div class="d-flex">
        <form action="{{ route('user.update_store', $store->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="d-flex flex-column col-lg-12">
                ...
                <div class=" mb-3">
                    ...
                    <input type="text" data-role="tagsinput" name="name_cate" value="{{ $nameCateByStore }}"
                        id="category" placeholder="Danh mục cửa hàng" class="form-control">
                </div>
                <div class=" mb-3">
                    <label for="" class="form-label">Châm ngôn</label>
                    <input type="text" name="slogan" placeholder="Slogan" value="{{ $store->slogan }}"
                        class="form-control">
                </div>
                <div class="mb-3">
                    <label for="">Thông điêp</label>
                    <input type="text" class="form-control" value="{{ $store->message }}"
                ...
                <div class="avatar-upload  mb-3">
                    ...
                    <div class="col-md-2 change-avatar">
                        <div class="avatar d-flex justify-content-center align-items-center bg-dark rounded-circle col-lg-12"
                            ...
                            <img src="@if ($store->avatar == '1/avatar-default-store.png') {{ asset("upload/store/1/avatar-default-store.png") }} @else {{ asset("upload/store/avatars/$store->avatar") }}@endif" alt=""
                ...
                <div class="avatar-upload  mb-3">
                    ...
                    <div class="file-upload">
                        ...
                        <div class="image-upload-wrap" @if ($store->background)
                            style="display: none"
                        @endif>
                        ...
                        <div class="file-upload-content" @if ($store->background)
                            style="display: block"
                        @endif>
                            <img class="file-upload-image" src="@if ($store->background == '1/background-default-store.png') {{ asset("upload/store/1/background-default-store.png") }} @else {{ asset("upload/store/backgrounds/$store->background") }}@endif" alt="your image" />
                ...
                <button type="submit" class="btn btn-primary fs-3 w-95">Cập nhật</button>
            </div>
