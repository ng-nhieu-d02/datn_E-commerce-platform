    ...
    <div class="container--chat--message">
        <div class="col-md-4">
            ...
            <ul class="friend-list" style="padding: 0;">
                ...
                <li class="room__{{$l_r->id}}" style="background: aliceblue;padding-left: 10px;border-bottom-left-radius: 20px;border-top-left-radius: 20px;">
                    <a href="{{route('user.store_chat', [$l_r->id_store, $l_r->id_user])}}" class="clearfix">
                        <img style="object-fit: cover; border-radius: 50%" src="{{ asset('upload/profile/avatar/' . $l_r->user->avatar) }}" alt="" class="img-circle">
                        <div class="friend-name">
                            <strong>{{$l_r->user->name}}</strong>
                        </div>
        ...
        <div class="col-md-8 bg-white container-message">
            ...
            <div class="chat-message">
                <ul class="chat container--messages container__messages__room__{{$room->id}}" style="padding: 0;">
                    ...
                    <li class="left clearfix">
                        <span class="chat-img pull-left">
                            <img style="object-fit: contain;" src="{{ asset('upload/profile/avatar/' . $room->user->avatar) }}" alt="User Avatar">
                        </span>
                        <div class="chat-body clearfix" style="background-image: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);">
                            <div class="header">
                                <strong class="primary-font">{{$room->user->name}}</strong>
            ...
            <div class="chat-box bg-white">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <button class="btn btn-success no-rounded btn-submit-message" data-id="{{$id_store}}" data-room="{{$room == null ? 'false' : $room->id}}" data-type="1" style="font-size: 1.5rem;" type="button">Send</button>
                    </span>
                </div><!-- /input-group -->
            </div>
            @endif
