...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order', function (Blueprint $table) {
            ...
            $table->bigInteger('coupons_price')->default(0);
            $table->bigInteger('total_price')->default(0);
            $table->bigInteger('ship')->default(0);
            $table->bigInteger('id_coupon_frs')->default(0);
            $table->bigInteger('coupons_frs_price')->default(0);
